...
class CustomPinCodeTextField extends StatelessWidget {
  ...
  Widget get pinCodeTextField => PinCodeTextField(
        ...
        pinTheme: PinTheme(
          ...
          activeFillColor: theme(context).colorScheme.primary,
          selectedFillColor: appTheme.white,
          activeColor: appTheme.orange300,
          selectedColor: appTheme.orange300,
          inactiveColor: theme(context).colorScheme.onPrimaryContainer,
