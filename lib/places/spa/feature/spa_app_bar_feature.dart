...
class SpaAppBarFeature extends StatefulWidget {
  const SpaAppBarFeature({super.key});

  @override
  State<SpaAppBarFeature> createState() => _SpaAppBarFeatureState();
}

class _SpaAppBarFeatureState extends State<SpaAppBarFeature> {
  @override
  void initState() {
    super.initState();
