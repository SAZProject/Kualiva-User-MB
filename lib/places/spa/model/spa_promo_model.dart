...
class SpaPromoModel {
  ...
  factory SpaPromoModel.fromMap(Map<String, dynamic> map) {
    return SpaPromoModel(
      id: map['id'] ?? '',
      name: map['name'] ?? '',
  ...
  factory SpaPromoModel.fromJson(String source) =>
      SpaPromoModel.fromMap(json.decode(source));

  @override
  String toString() {
    return 'SpaPromoModel(id: $id, name: $name, promoPercentage: $promoPercentage, averageRating: $averageRating, cityOrVillage: $cityOrVillage, categories: $categories, featuredImage: $featuredImage)';
  }
